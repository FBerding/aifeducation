...
-   Implements the advantages of the python library 'datasets',
    increasing computational speed and allowing the use of large data
    sets.
...
Using R syntax](https://fberding.github.io/aifeducation/articles/classification_tasks.html).
...
![Figure 1: Aifeducation
Studio](man/figures/home.png){width="100%"}
...
for a detailed overview.Tensorflow support will be removed with version 1.1.0 of
this package.
...
approaches such as MPNet (Song et al. 2020), BERT (Devlin et al.
...
*aifeducation* was successfully tested with the following configurations.
