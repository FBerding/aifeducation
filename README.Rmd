...
-   Supports both 'PyTorch' and 'Tensorflow' as machine learning
    frameworks.
-   Implements the advantages of datasets from the python library 'datasets' increasing
...
(graphical user interface) and older approaches (GlobalVectors, Topic Modeling).
