...
-   Simple usage of artificial intelligence by providing routines for
    the most important tasks for educators and researchers from social
    and educational science.
-   Provides a graphical user interface (Aifeducation Studio), allowing
    people to work with AI without any coding skills.
-   Supports 'PyTorch' as the core machine learning framework which is widely
    used in research.
...
-   Supports MPNet, BERT, RoBERTa, DeBERTa, Longformer, and Funnel Transformer
...
> Please note that an update of your version of *aifeducation* may require
an update of your python libraries. Refer to
[01 Get
Started](https://fberding.github.io/aifeducation/articles/aifeducation.html)
for more details.

Using the package with *R* syntax is described in the vignette 
...
![Figure 1: Aifeducation Studio](man/figures/gui_aife_readme.JPG){width="100%"}
...
the corresponding vignette for more details: [02 Using the graphical user interface Aifeducation - Studio](https://fberding.github.io/aifeducation/articles/gui_aife_studio.html).
...
providing a broad support of graphical devices to accelerate computations,
access to new and unique model architectures, and a high compatibility of models
across different versions of this machine learning framework.

'Tensorflow' is also supported but only for version 2.15 and not for all models.
Please refer to appendix [A01 Supported Machine Learning Frameworks](https://fberding.github.io/aifeducation/articles/Appendix_A01_Supported_Frameworks.html) 
for a detailed overview.

## Model Life Cycle

Research requires reproducibility and traceability. Thus, starting with version 
1.0.0 of this package ensuring that already trained models
work with future versions of this package has top priority. 
...
newer approaches such as MPNet (Song et al. 2020), BERT (Devlin et al. 2019), RoBERTa (Liu et al.
...
specialized and domain-specific models. See [04 Model configuration](model_configuration.html)
...
-   **digital data availability:** In the educational and social
    ...
    human action. This makes data generation financially expensive and
...
Since the package is based on 'PyTorch' and the transformer
library, every trained AI can be shared with other educators and
...
and the corresponding text embedding model. Use *AI for Education Studio* or
just load both to *R* and start predictions. 
...
Vignette [03 Using R syntax](classification_tasks.html)
...
-   [03 Using R syntax](classification_tasks.html): A short introduction into using the package with *R* syntax with examples for
    classification tasks.
