    ...
    for(pooling_type in pooling_type_list[[base_model]]){
      for(max_layer in max_layers){
        ...
        test_that(paste(framework,base_model,pooling_type,max_layer,min_layer,"embed"), {
          #general
          embeddings<-text_embedding_model$embed(raw_text = example_data$text[1:10],
          ...
          embeddings_perm<-text_embedding_model$embed(raw_text = example_data$text[perm],
        ...
        test_that(paste(framework,base_model,pooling_type,max_layer,min_layer,"embed single case"), {
          embeddings<-text_embedding_model$embed(raw_text = example_data$text[1:1],
        ...
        test_that(paste(framework,base_model,pooling_type,max_layer,min_layer,"encoding"), {
          encodings<-text_embedding_model$encode(raw_text = example_data$text[1:10],
        ...
        test_that(paste(framework,base_model,pooling_type,max_layer,min_layer,"fill_mask"), {
          ...
          second_solution<-text_embedding_model$fill_mask(text=paste("This is a",mask_token,"."),
                                                   n_solutions = 1)
          ...
          third_solution<-text_embedding_model$fill_mask(text=paste("This is a",mask_token,".",
