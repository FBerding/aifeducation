...
if(dir.exists(testthat::test_path("test_data/longformer"))==FALSE){
  dir.create(testthat::test_path("test_data/longformer"))
}

aifeducation::set_config_gpu_low_memory()

test_that("create_longformer_model", {
  ...
  expect_no_error(
    ...
    model_dir=testthat::test_path("test_data/longformer"),
