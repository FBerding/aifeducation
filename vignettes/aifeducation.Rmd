...
some further software. A list with links to downloads can be found here if you would
...
This step is only relevant if you would like to use graphic acceleration for 
your computations. If not you can skip this step.
