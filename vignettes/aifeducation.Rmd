...
on [https://protobuf.dev/installation/].
...
> work with models that use a tokenizer based on 'sentencepiece'. You can found
> a table with all transformers models in 
...
## Step 3 - Install Python and optional R packages
