...
`install="pytorch"` or `install="tenorflow"`. Starting with version 0.3.1 tensorflow
of version 2.13 or higher is necessary.
...
A guide how to use the graphical user interface can be found in vignette
  [02a classification tasks](gui_aife_studio.html). 
