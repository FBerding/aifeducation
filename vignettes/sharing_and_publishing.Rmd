...
Adding the model description of a classifier is similar to the `TextEmbeddingModel`s.
With the methods `set_model_description` and `get_model_description` you can provide
a detailed description of your classifier in English and the native language of your
