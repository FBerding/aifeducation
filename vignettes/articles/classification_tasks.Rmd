...
If you would like to use PyTorch you can skip this stept.
...
With `ml_framework="tensorflow"` you can decide which machine learning framework
should be used. You can choose between `ml_framework="tensorflow"` and 
`ml_framework="pytorch"`. Please note, that you can change the framework at any point.
...
In the case of transformers you can decide which machine learning framework should
be used for applying the model by specifying `ml_framework`. You can choose between
PyTorch(`ml_framework="pytorch"`) and tensorflow(`ml_framework="tensorflow"`). If you set
`ml_framework="auto"` the framework is used that was active when the model was saved.
...
With `ml_framework` you can choose which machine learning framework you would like
to use. Since the classifier is written with 'keras' using a classifier with
