...
to add. You have three choices: "developer", and "modifier",
...
In contrast to \link{TextEmbeddingModels} there are not different types of
author groups.
...
```{r, include = TRUE, eval=FALSE}
example_classifier$set_licens("CC BY-NC-SA")
```
