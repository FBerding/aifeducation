...
author: "Florian Berding, Yuliia Tykhonova"
...
See [Transformer Maker Class for Developers](https://fberding.github.io/aifeducation/reference/AIFETransformerMaker.html) for details.
...
# or
# transformer <- aife_transformer_maker$make("deberta")
```
...
## 4.3 Using A New Transformer

Now use the transformer (created in p. 4.2) like in the code example 
from p. 2.1.

To implement the transformer in [AIFETransformerMaker](https://fberding.github.io/aifeducation/reference/AIFETransformerMaker.html), add the type
of the transformer to the [AIFETrType](https://fberding.github.io/aifeducation/reference/AIFETrType.html) and a case into `make`-method:
...
AIFETrType <- list(
  ...
  roberta = # ...
  # ...
  custom = "custom"                              # (1) new type
)

# make-method in the TransformerMaker class
make = function(type) {
  transformer <- NULL
  ...
  # ...
  # implemented transformer cases
  # ...
   else if (type == AIFETrType$custom) {         # (2) New custom case
    transformer <- .AIFECustomTransformer$new()
  } else {
    # ...
    # stop(...)
  }
...
[AIFETrType](https://fberding.github.io/aifeducation/reference/AIFETrType.html) list and [AIFETransformerMaker](https://fberding.github.io/aifeducation/reference/AIFETransformerMaker.html) class is located in 
"R/AIFETransformerMaker.R" file.

Use the Transformer Maker class to create a custom transformer like in p. 3.2.
