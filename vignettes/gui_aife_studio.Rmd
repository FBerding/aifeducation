...
[![Figure `r running_num_figures`: Base Models - Create
...
[![Figure `r running_num_figures`: Base Models - Train/Tune
...
[![Figure `r running_num_figures`: Text Embedding Model -
...
[![Figure `r running_num_figures`: Text Embedding Model - Fill
...
[![Figure `r running_num_figures`: Classifier - Creation Part
...
[![Figure `r running_num_figures`: Classifier -
...
![Figure `r running_num_figures`: Classifier - Prediction
...
![Figure `r running_num_figures`: Basic architecure of feature
...
during configuration of the classifier (Figure `r running_num_figures`).
