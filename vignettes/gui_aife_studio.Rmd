...
app. Figure 10 shows the corresponding page.
...
The tab *Description* (Figure 13) provides you with the documentation of the
model.
...
The tab *Embedd Text* (Figure 14) allows you to transform raw texts into
...
The tab *Tokenize/Encode/Decode* (Figure 15) offers you insights into the way your
...
[![Figure 15: Text Embedding Model - Tokenize/Encode/Decode](img_articles/gui/TEM_Use_TED_Encode.png){width="100%"}](img_articles/gui/TEM_Use_TED_Encode.png)
Figure 15: Text Embedding Model - Tokenize/Encode/Decode (click image to enlarge)
