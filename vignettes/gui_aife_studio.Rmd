...
![Figure 12: DataExplorer](DM_DataExplorer.png){width="50%"}
...
.rda/.rdata. Figure 13 illustrates an example for a .xslx file.

![Figure 13: Target Data in Excel Files](CF_Create_Targets.png){width="50%"}
...
![Figure 14: TableEditor](DM_TableEditor.png){width="50%"}
...
[![Figure 15: Base Models - Create
Transformer](BM_Create_Fill_fields.png){width="100%"}](BM_Create_Fill_fields.png)
Figure 15: Base Models - Create Transformer (click image to enlarge)
...
[![Figure 16: Base Models - Train/Tune
Transformer](BM_Train_Fill_fields.png){width="100%"}](BM_Train_Fill_fields.png)
Figure 16: Base Models - Train/Tune Transformer (click image to enlarge)
...
progress bars and plot (Figure 17).

![Figure 17: Progress of training the
...
section "Text Embedding Models". Figure 18 shows the corresponding page.

[![Figure 18: Text Embedding Model -
Create](TEM_Create_Fill_fields.png){width="100%"}](TEM_Create_Fill_fields.png)
Figure 18: Text Embedding Model - Create (click image to enlarge)
...
The tab *Description* (Figure 19) provides you with the documentation of
the model.

[![Figure 19: Text Embedding Model -
Description](TEM_Use_Fill_fields.png){width="100%"}](TEM_Use_Fill_fields.png)
Figure 19: Text Embedding Model - Description (click image to enlarge)
...
The tab *Embedd Text* (Figure 20) allows you to transform raw texts into
...
[![Figure 20: Text Embedding Model -
...
The tab *Tokenize/Encode/Decode* (Figure 21) offers you insights into
...
Finally, the tab *Fill Mask* (Figure 22) allows you to request the
...
[![Figure 22: Text Embedding Model - Fill
Mask](TEM_Use_Fill_mask.png){width="100%"}](TEM_Use_Fill_mask.png)
Figure 22: Text Embedding Model - Fill Mask (click image to enlarge)
...
[![Figure 23: Text Embedding Model -
Documentation](TEM_Document_Desc_english.png){width="100%"}](TEM_Document_Desc_english.png)
Figure 23: Text Embedding Model - Documentation (click image to enlarge)
...
allowing you to reach a broader audience (Figure 23). In all four tabs
...
Figure 24: Classifier - Creation Part 1 (click image to enlarge)
...
neural network (Figure 25).

[![Figure 25: Classifier - Creation Part
2](CF_Create_Fill_fields_2.png){width="100%"}](CF_Create_Fill_fields_2.png)
Figure 25: Classifier - Creation Part 2 (click image to enlarge)
...
your classifier (Figure 26). Going into detail is again beyond the scope
...
[![Figure 26: Classifier - Creation Part
3](CF_Create_Fill_fields_3.png){width="100%"}](CF_Create_Fill_fields_3.png)
Figure 26: Classifier - Creation Part 3 (click image to enlarge)
...
In the first tab, *Description* (Figure 27), you will find the
documentation of the model.

[![Figure 27: Classifier -
Description](CF_Use_Fill_fields.png){width="100%"}](CF_Use_Fill_fields.png)
Figure 27: Classifier - Description (click image to enlarge)

In the second tab, *Training* (Figure 28), you receive a summary of the
...
Figure 28: Classifier - Training (click image to enlarge)
...
[![Figure 29: Classifier -
Reliability](CF_Use_Reliability.png){width="100%"}](CF_Use_Reliability.png)
Figure 29: Classifier - Reliability (click image to enlarge)

The last tab, *Prediction* (Figure 30), allows you to apply a trained
...
[![Figure 30: Classifier -
Prediction](CF_Use_Prediction_1.png){width="100%"}](CF_Use_Prediction_1.png)
Figure 30: Classifier - Prediction (click image to enlarge)
...
![Figure 31: Classifier - Prediction
...
![Figure 32: Basic architecure of feature
...
during configuration of the classifier (Figure 25).
