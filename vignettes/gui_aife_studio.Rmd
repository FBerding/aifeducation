...
![Figure 4: Home Page](home.png){width="100%"}
...
![Figure 5: Data Management Page](DM_Create.png){width="100%"} 
...
![Figure 6: Data Preparation Page](DM_Create_Fill_fields.png){width="100%"}
...
![Figure 7: Structure of Raw Texts within an Excel Sheet](DM_Create_Excel_file.png){width="75%"}
...
![Figure 8: Selecting a path for a data set](DM_Create_Start_creation.png){width="100%"}
...
![Figure 9: Progress of Dataset creation process](DM_Create_Progress.png){width="100%"}
...
![Figure 10: Progress of Dataset creation process](DM_Create_Success.png){width="100%"}
...
![Figure 11: Filnames as IDs](DM_Create_Text_sources.png){width="75%"}
...
![Figure 12: Filnames as IDs](CF_Create_Targets.png){width="50%"}
...
[![Figure 13: Base Models - Create Transformer](BM_Create_Fill_fields.png){width="100%"}](BM_Create_Fill_fields.png)
...
[![Figure 14: Base Models - Train/Tune  Transformer](BM_Train_Fill_fields.png){width="100%"}](BM_Train_Fill_fields.png)
...
![Figure 15: Progress of training the transformer](BM_Train_Progress.png){width="100%"}
...
[![Figure 16: Text Embedding Model - Create](TEM_Create_Fill_fields.png){width="100%"}](TEM_Create_Fill_fields.png)
...
[![Figure 17: Text Embedding Model - Description](TEM_Use_Fill_fields.png){width="100%"}](TEM_Use_Fill_fields.png)
...
[![Figure 18: Text Embedding Model - Embeddings](TEM_Use_Embedd_text.png){width="100%"}](TEM_Use_Embedd_text.png)
...
[![Figure 19: Text Embedding Model - Tokenize/Encode/Decode](TEM_Use_TED_Encode.png){width="100%"}](TEM_Use_TED_Encode.png)
...
[![Figure 20: Text Embedding Model - Fill Mask](TEM_Use_Fill_mask.png){width="100%"}](TEM_Use_Fill_mask.png)
...
[![Figure 21: Text Embedding Model - Documentation](TEM_Document_Desc_english.png){width="100%"}](TEM_Document_Desc_english.png)
...
[![Figure 22: Classifier - Creation Part 1](CF_Create_Fill_fields_1.png){width="100%"}](CF_Create_Fill_fields_1.png)
...
[![Figure 23: Classifier - Creation Part 2](CF_Create_Fill_fields_2.png){width="100%"}](CF_Create_Fill_fields_2.png)
...
[![Figure 24: Classifier - Creation Part 3](CF_Create_Fill_fields_3.png){width="100%"}](CF_Create_Fill_fields_3.png)
...
[![Figure 25: Classifier - Description](CF_Use_Fill_fields.png){width="100%"}](CF_Use_Fill_fields.png)
...
[![Figure 26: Classifier - Training](CF_Use_Training.png){width="100%"}](CF_Use_Training.png)
...
[![Figure 27: Classifier - Reliability](CF_Use_Reliability.png){width="100%"}](CF_Use_Reliability.png)
...
[![Figure 28: Classifier - Prediction](CF_Use_Prediction_1.png){width="100%"}](CF_Use_Prediction_1.png)
...
![Figure 29: Classifier - Prediction Results](CF_Use_Prediction_Result.png){width="50%"}
...
![Figure 30: Basic architecure of feature extractors](FE_Create_Fill_fields.png){width="100%"}
