...
Allaire (2022, pp. 373) for both variants of attention. 
...
by keras. Classifiers created for pytorch are saved as .pt in all cases. Thus,
`save_format` is ignored.
