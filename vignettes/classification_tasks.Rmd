...
In our example we use only two encoder layers (`tf_n_layers=2`) and 
two dense layers (`dense_n_layers=0`). All other layers are omitted from the model
by setting the number of layers to zero (`conv_n_layers=0`,`rec_n_layers=0`).
