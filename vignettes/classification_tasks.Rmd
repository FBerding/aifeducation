...
```{r, include = TRUE, eval = TRUE}
tokenizer$encode(raw_text = "This is a good movie.",
...
```{r, include = TRUE, eval = TRUE}
tokenizer$decode(int_seqence = list(list(c(0,  53, 109, 174, 188,  61,  67,  97,  97, 112,  73,  97, 110,  99, 101,  17,   1))),
                 to_token=TRUE)
```
...
```{r, include = TRUE, eval = TRUE}
tokenizer$get_sustainability_data("training")$track_log
```
...
```{r, include = TRUE, eval = TRUE}
base_model$fill_mask(masked_text = "This is a [MASK] movie.",
                     n_solutions = 5)
```
...
```{r, include = TRUE, eval = TRUE}
base_model$get_sustainability_data("training")$track_log
```
