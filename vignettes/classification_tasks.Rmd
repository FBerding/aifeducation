...
```{r, include = TRUE, eval = TRUE}
base_model_roberta_xml <- BaseModelRobertaXML$new()
base_model_roberta_xml$create_from_hf(
...
```{r, include = TRUE, eval = TRUE}
chunk_quantile = base_model_roberta_xml$Tokenizer$calc_quantiles(
  text_dataset = data_set_reviews_text, 
  batch_size = 32L, 
  seq_len_tokens = 512L,
  token_overlap=128L,
...
tem$configure(
  ...
  base_model = base_model_roberta_xml,
