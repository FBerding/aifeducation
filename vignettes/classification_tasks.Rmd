...
a `bib_entry.txt` and `license.txt` to every folder is optional. If there is no 
...
Please not that the file for the bib_entry and the license must be a .txt file 
not a .pdf file.
...
As stated above ``bib_entry.txt` and `license.txt` are optional.
...
|id |text|bib|license|
|---|---|---|---|
|z3   |This is an example.   |Autor (2019)   |CC BY   |
|a3   |This is a second example.   |Author (2022)   |CC BY   |
|...   |...   |...   |...   | 
