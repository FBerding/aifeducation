...
and the number of neurons. In our example, there is one dense layers with 5 neurons.
...
6 neurons each. With `rec_type` you can choose between two types of recurrent layers.
