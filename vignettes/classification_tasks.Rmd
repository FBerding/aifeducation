...
```{r, include = TRUE, eval=TRUE, fig.cap=paste0("Figure ",`r running_num_figures`,": Embeddings of an untrained classifier of type 'ProtoNet'")}
...
```{r, include = TRUE, eval=TRUE, fig.cap=paste0("Figure ",`r running_num_figures`,": Embeddings of a trained classifier of type 'ProtoNet' without unlabeled cases")}
...
```{r, include = TRUE, eval=TRUE, fig.cap=paste0("Figure ",`r running_num_figures`,": Embedding of a trained classifier of type 'ProtoNet' including unlabeled cases")}
...
``` {r, include =TRUE, eval=TRUE, fig.cap=paste0("Figure ",`r running_num_figures`,": Embeddings of a trained classifier of type 'ProtoNet' trained for two classes and applied for a sample set with four classes.")}
...
```{r, include = TRUE, eval=TRUE, fig.cap=paste0("Figure ",`r running_num_figures`,": Training History of a Feature Extractor.")}
