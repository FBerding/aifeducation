...
two dense layers (`dense_n_layers = 2`). All other layers are omitted from the model
...
where all neurons of the previous layer are connected all classes. 
...
you can plot a smoothed version of average iota which is more precise.
...
to the initial loss. The values express the degree in percentage to the initial loss.
