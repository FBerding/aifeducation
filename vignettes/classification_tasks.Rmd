...
![Figure 2: Basic Structure of Supervised Machine Learning](classif_gif_02.png){width=100%}
...
![Figure 3: Overview of the Steps to Perform a Classification](classif_gif_03.png){width=100%}
...
Thus, our example text embedding model is able to process texts with about 15*512=7680 tokens.
 ...
 *Adaptive Synthetic Sampling Approach for Imbalanced Learning*. The aim is to 
 ...
 (`bpl_inc_ratio`) in every step for the training of the next step.
...
![Figure 4: Overview of the Training Loop for all Options Activiated](classif_gif_04.png){width=100%}
