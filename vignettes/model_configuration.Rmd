...
Good values for the base learning rate for batch sizes between 4 and 32 are in the range of 
...
Based on these results we recommend to start with `batch_size=32` and `lr_rate=3e-2`.
