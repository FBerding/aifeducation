...
extractor (`fe_method="Dense"`). To use it for classifier training, create a
`TEFeatureExtractor` and provide the trained extractor during the 
configuration of the classifier. See section "Extension" in vignette [03 Using R
