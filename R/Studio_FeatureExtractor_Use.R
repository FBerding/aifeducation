#'Graphical user interface for feature extractors - use
#'
#'Functions generates the page for using a [TEFeatureExtractor].
#'
...
#'Server function for: graphical user interface for feature extractors - use
#'
...
FeatureExtractors_Use_Server <- function(id, log_dir, volumes) {
  moduleServer(id, function(input, output, session) {
    ...
    Description_Server(id="FeatureExtractor_Desc",
                       model=model)
    Training_Server(id="FeatureExtractor_Training",
                    model=model)
    #--------------------------------------------------------------------------
  })
}
