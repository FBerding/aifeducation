...
#'the creation and training of a classifier an object of class [EmbeddedText] or [LargeDataSetForTextEmbeddings] and a `factor`
#'are necessary. The object of class [EmbeddedText] or [LargeDataSetForTextEmbeddings] contains the numerical text
...
#'[EmbeddedText] or [LargeDataSetForTextEmbeddings] has to be used which was created with the same [TextEmbeddingModel] as
#'for training.
#'
...
TEClassifierProtoNet<-R6::R6Class(
  ...
  public = list(
    ...
    #'@param encoder_dropout `double` ranging between 0 and lower 1, determining the
    #'dropout for the dense projection within the encoder layers.
    #'@param dense_dropout `double` ranging between 0 and lower 1, determining the
    #'dropout between dense layers.
    #'@param rec_dropout `double` ranging between 0 and lower 1, determining the
    #'dropout between bidirectional recurrent layers.
    #'@param recurrent_dropout `double` ranging between 0 and lower 1, determining the
    ...
    #'@param loss_alpha `double` Value between 0 and 1 indicating how strong
    ...
    #'@param loss_margin `double` Value greater 0 indicating the minimal
  ...
  #---------------------------------------------------------------------------
  #'@description Method for embedding documents. Please do not confuse this type of
  #'embeddings with the embeddings of texts created by an object of class [TextEmbeddingModel].
  #'These embeddings embed documents according to their similarity to
  #'specific classes.
  #'@param embeddings_q Object of class [EmbeddedText] or [LargeDataSetForTextEmbeddings] containing
  ...
  #' * `embeddings_prototypes`: embeddings of the prototypes which were learned
  #' during training. They represents the center for the different classes.
  #'
  ...
  #---------------------------------------------------------------------------
  #'@description Method for creating a plot to visualize embeddings and their
  #'corresponding centers (prototypes).
  #'@param embeddings_q Object of class [EmbeddedText] or [LargeDataSetForTextEmbeddings] containing
  #'the text embeddings for all cases which should be embedded into the classification space.
  #'@param classes_q Named `factor` containg the true classes for every case. Please note that
  #'the names must match the names/ids in `embeddings_q`.
  #'@param batch_size `int` batch size.
