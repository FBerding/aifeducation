...
#'
#' Function for installing 'aifeducation' on a machine. This functions assumes
#' that not 'python' and no 'miniconda' is installed. Only'pytorch' is installed.
#'
...
#'
#' @return Function does nothing return. It installes python, optional R packages, and
#' necessary 'python' packages on a machine.
#'
