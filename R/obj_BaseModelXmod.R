  ...
  private = list(
    ...
    create_model = function(args) {
      configuration <- transformers$XmodConfig(
        ...
        default_language = if(is.null(args$default_language)){args$languages[1L]} else{args$default_language},
        is_decoder=FALSE,
...
BaseModelsIndex$Xmod <- list(
  ...
  Riedel, S., & Artetxe, M. (2022). Lifting the Curse of Multilinguality
  by Pre-training Modular Transformers. arXiv. doi: [0.48550/ARXIV.2205.06266](https://doi.org/0.48550/ARXIV.2205.06266)",
