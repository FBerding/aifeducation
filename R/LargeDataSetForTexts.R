...
LargeDataSetForText <- R6::R6Class(
  ...
  public = list(
    ...
    #' create an informative data set every folder can contain the following
    #' additional files:
    #'
    ...
    #' Id and raw texts are mandatory, bibliographic, license, license's url,
    #' license's text, and source's url are optional.
    ...
    #' the licenses.
    #' @param url_license_column `string` Name of the column storing information about
    #' the url to the license in the internet.
    #' @param text_license_column `string` Name of the column storing the license as text.
    #' @param url_source_column `string` Name of the column storing information about
    #' about the url to the source in the internet.
    ...
    #' columns "id","text","bib_entry", "license", "url_license", "text_license", and
    #' "url_source". If a column is missing
